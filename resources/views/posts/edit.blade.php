...
<div class="max-w-3xl mx-auto p-6">
    ...
    <!-- 戻るボタン -->
    @php
        $returnUrl = request()->get('return', url('/posts'));
    @endphp
    <a href="{{ $returnUrl }}"
    ...
    <!-- 編集フォーム -->
    <form method="POST" action="/posts/{{ $post->id }}" class="space-y-6 p-6 backdrop-blur-md bg-white/10 rounded-2xl shadow-2xl">
        @csrf
        @method('PUT')
